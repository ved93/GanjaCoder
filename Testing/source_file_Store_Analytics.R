...
# "ID" , "StoreID","ProductID","Date","Day","Temp","Sales" 
...
Store_data<-Store_data[,c(args14[14] , args14[15], args14[16], args14[17],args14[18],args14[19],args14[20])]
...
Store_data<-Store_data[,c(args14[15],args14[16],args14[17],args14[18],args14[19],args14[20],args14[21])]
...
{ 
  ...
  Rainfall_data<- Rainfall_data[,c(args13[13] , "Date" )]
  
  #Rainfall_data<- Rainfall_data[,c("Rainfall" , "Date", "var1" , NULL)]
